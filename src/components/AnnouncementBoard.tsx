...
function NewAnnouncementButton() {
  return (
    <details className="group relative">
      ...
      <div className="absolute right-0 top-full z-30 mt-2 w-[min(420px,90vw)] rounded-2xl bg-cream-100 border border-ink-300/40 shadow-[0_20px_60px_rgba(15,23,42,0.10)] animate-fade-up">
