    ...
    <main className="min-h-[100dvh] bg-cream-50 px-6 py-24">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mt-8">
          <Link
            href="/"
            className="group inline-flex items-center gap-1 rounded-full bg-accent-lime py-2.5 pl-5 pr-2 text-[12px] font-medium uppercase tracking-[0.18em] text-cream-50 transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-accent-lime/85 active:scale-[0.98]"
          >
