    ...
    <main className="min-h-[100dvh] bg-cream-50 px-6 py-24">
      <div className="mx-auto max-w-2xl text-center">
        <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-cream-100 border border-ink-300/30 px-3 py-1 text-[10px] uppercase tracking-[0.22em] text-ink-500">
          <span className="inline-block h-1.5 w-1.5 rounded-full bg-ink-500" />
          404
        </div>
        ...
        <div className="mt-8">
          <Link
            href="/"
            className="group inline-flex items-center gap-1 rounded-full bg-accent-lime py-2.5 pl-5 pr-2 text-[12px] font-medium uppercase tracking-[0.18em] text-on-accent transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-accent-lime/85 active:scale-[0.98]"
          >
