                ...
                <div className="mb-2 flex items-center justify-between">
                  ...
                  {tasks.length > 1 && (
                    <button
                      ...
                      className="rounded-full bg-cream-50 p-1.5 text-ink-500 border border-ink-300/40 transition hover:bg-accent-rust hover:text-on-accent hover:border-accent-rust"
                    >
